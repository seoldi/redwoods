				...
				<div id="news">
					...
					<div class="container moPd">
						...
						for ($i=0; $i<count($list); $i++) {
						 ?>
						<div class="item <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
							<?php if ($is_checkbox) { ?>
							<p class="chk">
							...
							<?php } ?>
							<p class="company"><span><?=$list[$i]['wr_1']?></span></p>
							...
							<p class="date"><?=$list[$i]['wr_3'] ?></p>
							<p class="btn-wrap">
								<a class="news" href="<?=$list[$i]['wr_2'] ?>" target="blank"></a>
								<?php if ($is_admin) { ?>
									<a class="view" href="<?php echo $list[$i]['href'] ?>">View</a>
								<?php } ?>
							</p>
						</div>
