		...
		<section id="bo_w">
				...
				<div class="bo_w_tit write_div">
						...
						<div id="autosave_wrapper write_div">
								<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="뉴스 제목">
						...
						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_1" value="<?php echo $write['wr_1']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="언론사 : ex)부산일보">
						</div>

						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_3" value="<?php echo $write['wr_3']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="보도일자 : ex)2022-10-25">
						</div>

						<div id="autosave_wrapper write_div mt10">
							<input type="text" name="wr_2" value="<?php echo $write['wr_2']?>"  required class="frm_input full_input required" size="50" maxlength="255" placeholder="뉴스링크">
						</div>
