...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li class="pc_view"><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="작성"><i class="fa fa-pen" aria-hidden="true"></i><span class="sound_only">작성</span></a></li><?php } ?>
