				...
				<div class="bo_list_head">
					<ul>
						<li>
							...
							<span class="s-name">성명</span>
							<span class="s-old">연령대</span>
							<span class="s-sex">성별</span>
							<span class="s-inflow">유입경로</span>
							<span class="s-tel">연락처</span>
							<span class="s-location">거주지</span>
							<span class="s-date">등록일</span>
				...
				<div class="bo_list">
					<ul>
						...
						?>
							...
							<span class="s-name" onclick="location.href='<?php echo $list[$i]['href'] ?>'"><?php echo $list[$i]['name'] ?></span>
							<span class="s-old"><?php echo $list[$i]['wr_6'] ?></span>
							<span class="s-sex"><?php echo $list[$i]['wr_7'] ?></span>
							<span class="s-inflow"><?php echo $list[$i]['wr_8'] ?></span>
							<span class="s-tel"><?php echo $list[$i]['wr_1']; ?></span>
							<span class="s-location"><?php echo $ex_addr1; ?></span>
							<span class="s-date">
