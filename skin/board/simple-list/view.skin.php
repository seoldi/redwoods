...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
      <div class="title-box">
          ...
          ?></p>
					<span class="date dateForm"><span class="sound_only">작성일</span><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></span>
			</div>
    </header>
  ...
  <?php if ($prev_href || $next_href) { ?>
    <ul class="other-board">
      <?php if ($prev_href) { ?>
        <li>
          <span class="prev">이전글</span>
          <p>
            <a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a>
            <b class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></b>
          </p>
